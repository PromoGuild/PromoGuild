...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/promoguild-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/promoguild-cli.cpp \
           src/promoguild-tx.cpp \
           src/promoguild.cpp \
           src/db.cpp \
           ...
           src/qt/promoguild.cpp \
           src/qt/promoguildstrings.cpp \
...
RESOURCES += src/qt/promoguild.qrc src/qt/promoguild_locale.qrc

TRANSLATIONS += src/qt/locale/promoguild_bg.ts \
                src/qt/locale/promoguild_de.ts \
                src/qt/locale/promoguild_en.ts \
                src/qt/locale/promoguild_es.ts \
                src/qt/locale/promoguild_fi.ts \
                src/qt/locale/promoguild_fr.ts \
                src/qt/locale/promoguild_it.ts \
                src/qt/locale/promoguild_ja.ts \
                src/qt/locale/promoguild_pl.ts \
                src/qt/locale/promoguild_pt.ts \
                src/qt/locale/promoguild_ru.ts \
                src/qt/locale/promoguild_sk.ts \
                src/qt/locale/promoguild_sv.ts \
                src/qt/locale/promoguild_vi.ts \
                src/qt/locale/promoguild_zh_CN.ts \
                src/qt/locale/promoguild_zh_TW.ts
