UNIX BUILD NOTES
====================
Some notes on how to build Promoguild in Unix.
...
memory available when compiling Promoguild Core. With 512MB of memory or less
...
If you want to build Promoguild-Qt, make sure that the required packages for Qt development
...
BDB_PREFIX="${Promoguild_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Promoguild Core to use our own-built instance of BDB
cd $Promoguild_ROOT
...
Security
--------
To help make your Promoguild installation more secure by making certain attacks impossible to
