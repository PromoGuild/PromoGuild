...
*Setup instructions for a gitian build of Promoguild using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Promoguild
...
- [Building Promoguild](#building-digiwage)
...
To build Promoguild (for Linux, OSX and Windows) just follow the steps under 'perform
