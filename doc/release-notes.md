Promoguild Core version 2.3.1 is now available from:
...
Promoguild Core is extensively tested on multiple operating systems using
...
Promoguild Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Promoguild address of payment
