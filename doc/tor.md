TOR SUPPORT IN Promoguild
=======================

It is possible to run Promoguild as a Tor hidden service, and connect to such services.
...
Run Promoguild behind a Tor proxy
----------------------------------

The first step is running Promoguild behind a Tor proxy. This will already make all
...
Run a Promoguild hidden server
-------------------------------
...
List of known Promoguild Tor relays
------------------------------------
```
