...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='promoguild.conf'
CONFIGFOLDER='/root/.promoguild'
COIN_DAEMON='promoguildd'
COIN_CLI='promoguild-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/PromoGuild/PromoGuild.git'
COIN_TGZ=''
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Promoguild'
COIN_PORT=15711
RPC_PORT=15712
