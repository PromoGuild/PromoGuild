/* src/config/promoguild-config.h.  Generated from promoguild-config.h.in by configure.  */
/* src/config/promoguild-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://promoguild.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Promoguild Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Promoguild Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "promoguild"
