...
#if defined(NDEBUG)
#error "Promoguild cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Promoguild Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if( nHeight >= 1 && nHeight <= 1500 ) {
	    nSubsidy = 0 * COIN;
    } else if (nHeight >= 1501 && nHeight < 1995) {
        nSubsidy = 0.1 * COIN;
    } else if (nHeight >= 1996 && nHeight < 10000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 10001 && nHeight < 20000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 20001 && nHeight < 26000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 26001 && nHeight < 50000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 50001 && nHeight < 100000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 100001 && nHeight < 300000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 300001 && nHeight < 3000000) {
        nSubsidy = 10 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
...
{
    RenameThread("promoguild-scriptch");
