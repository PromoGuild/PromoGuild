...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Promoguild Core promoguild-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  promoguild-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded promoguild transaction") + "\n" +
                               "  promoguild-tx [options] -create [commands]   " + _("Create hex-encoded promoguild transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded promoguild transaction
