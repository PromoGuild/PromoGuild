                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Promoguild-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Promoguild address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and promoguild: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Promoguild Core"), this);
    aboutAction->setStatusTip(tr("Show information about Promoguild Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Promoguild"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Promoguild addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Promoguild addresses"));
    ...
    openAction->setStatusTip(tr("Open a Promoguild: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Promoguild Core help message to get a list with possible Promoguild command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Promoguild Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Promoguild network", "", count));
}
...
{
    QString strTitle = tr("Promoguild Core"); // default title
