...
/** Utility functions used by the PGD Qt UI.
 */
namespace GUIUtil
{
...
// Render PGD addresses in monospace font
...
// Parse "promoguild:" URI into recipient object, return true on successful parsing
