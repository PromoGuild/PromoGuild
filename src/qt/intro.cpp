...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Promoguild Core"),
     ...
     * override -datadir in the promoguild.conf file in the default data directory
     * (to be consistent with promoguildd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
