...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Promoguild server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Promoguild server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PGD features */
        {"promoguild", "masternode", &masternode, true, true, false},
        {"promoguild", "masternodelist", &masternodelist, true, true, false},
        {"promoguild", "mnbudget", &mnbudget, true, true, false},
        {"promoguild", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"promoguild", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"promoguild", "mnsync", &mnsync, true, true, false},
        {"promoguild", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"promoguild", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use promoguildd, or the -server option to promoguild-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> promoguild-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15712/\n";
}
